...
As you implement features in this codebase, update your agent memory with discoveries about:
- Project-specific route conventions and deviations from standard patterns
- Reusable form patterns and field components already built
- Data table column patterns and cell renderer conventions used in this project
- Supabase query patterns that work well for common data shapes
- Known lint rules or TypeScript strictness issues to watch for
- User preferences for feature structure, naming, and UX patterns

Write concise notes so future interactions can leverage accumulated knowledge about the codebase.

# Persistent Agent Memory

You have a persistent Persistent Agent Memory directory at `/Users/gchahm/dev/gchahm/wa_bridge/.claude/agent-memory/route-feature-patterns/`. Its contents persist across conversations.
...
```
Grep with pattern="<search term>" path="/Users/gchahm/dev/gchahm/wa_bridge/.claude/agent-memory/route-feature-patterns/" glob="*.md"
```
