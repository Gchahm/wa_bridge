...
-- Purpose:   Add customer management tables (public.customers and
--            public.customer_relationships) with RLS policies, grants,
--            an updated_at trigger, and an enriched view for PostgREST access.
--
